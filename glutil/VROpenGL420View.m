...
@implementation VROpenGL420View
...
#define FSH420 @"varying lowp vec2 TexCoordOut;\
\
...
- (void)loadShader
{
    ...
    GLuint fragmentShader = [self compileShader:FSH420 withType:GL_FRAGMENT_SHADER];
